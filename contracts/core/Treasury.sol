...
contract Treasury is Ownable, Pausable, ReentrancyGuard {
    ...
    // Research funding - specialized streaming payment for research proposals
    function fundResearch(address recipient, uint256 amount, uint256 duration) external onlyOwner whenNotPaused {
        require(recipient != address(0), "invalid recipient");
        require(amount > 0, "amount must be > 0");
        require(duration > 0, "duration must be > 0");
        require(address(this).balance >= amount, "insufficient ETH balance");
...
>>>>>>> 690363bd19272191d360b41758f8732f6805e6d8:contracts/Treasury.sol
