...
describe("Governance Integration", function () {
  ...
  async function deployGovernanceFixture() {
    ...
    // Wire ReputationManager to Governor
    await governor.setReputationManager(reputationManager.target);
    const REPUTATION_MANAGER_ROLE = await reputationManager.REPUTATION_MANAGER_ROLE();
    await reputationManager.grantRole(REPUTATION_MANAGER_ROLE, governor.target);
